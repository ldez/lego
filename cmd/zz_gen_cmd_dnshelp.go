...
func displayDNSHelp(w io.Writer, name string) error {
	...
	case "connbyte":
		// generated from: providers/dns/connbyte/connbyte.toml
		ew.writeln(`Configuration for Connbyte.`)
		ew.writeln(`Code:	'connbyte'`)
		ew.writeln(`Since:	'v5.1.0'`)
		ew.writeln()

		ew.writeln(`Credentials:`)
		ew.writeln(`	- "CONNBYTE_TOKEN":	Token`)
		ew.writeln()

		ew.writeln(`Additional Configuration:`)
		ew.writeln(`	- "CONNBYTE_HTTP_TIMEOUT":	API request timeout in seconds (Default: 30)`)
		ew.writeln(`	- "CONNBYTE_POLLING_INTERVAL":	Time between DNS propagation check in seconds (Default: 2)`)
		ew.writeln(`	- "CONNBYTE_PROPAGATION_TIMEOUT":	Maximum waiting time for DNS propagation in seconds (Default: 60)`)
		ew.writeln(`	- "CONNBYTE_TTL":	The TTL of the TXT record used for the DNS challenge in seconds (Default: 120)`)

		ew.writeln()
		ew.writeln(`More information: https://go-acme.github.io/lego/dns/connbyte`)
	...
	case "dnsupdate":
		...
		ew.writeln()
		ew.writeln(`More information: https://go-acme.github.io/lego/dns/dnsupdate`)
	...
	case "gcloud":
		...
		ew.writeln(`Additional Configuration:`)
		ew.writeln(`	- "GCE_ACCESS_TOKEN":	The OAuth2 access token used by the client to authenticate against the Google Cloud API.`)
	...
	case "ngenix":
		...
		ew.writeln(`	- "NGENIX_POLLING_INTERVAL":	Time between DNS propagation check in seconds (Default: 20)`)
		ew.writeln(`	- "NGENIX_PROPAGATION_TIMEOUT":	Maximum waiting time for DNS propagation in seconds (Default: 600)`)
	...
	case "openprovider":
		...
		ew.writeln(`Additional Configuration:`)
		ew.writeln(`	- "OPENPROVIDER_HTTP_TIMEOUT":	API request timeout in seconds (Default: 30)`)
		ew.writeln(`	- "OPENPROVIDER_POLLING_INTERVAL":	Time between DNS propagation check in seconds (Default: 10)`)
		ew.writeln(`	- "OPENPROVIDER_PROPAGATION_TIMEOUT":	Maximum waiting time for DNS propagation in seconds (Default: 600)`)
		ew.writeln(`	- "OPENPROVIDER_TTL":	The TTL of the TXT record used for the DNS challenge in seconds (Default: 600)`)
	...
	case "zilore":
		// generated from: providers/dns/zilore/zilore.toml
		ew.writeln(`Configuration for Zilore.`)
		ew.writeln(`Code:	'zilore'`)
		ew.writeln(`Since:	'v5.0.0'`)
		ew.writeln()

		ew.writeln(`Credentials:`)
		ew.writeln(`	- "ZILORE_ACCESS_KEY":	Access key`)
		ew.writeln()

		ew.writeln(`Additional Configuration:`)
		ew.writeln(`	- "ZILORE_HTTP_TIMEOUT":	API request timeout in seconds (Default: 30)`)
		ew.writeln(`	- "ZILORE_POLLING_INTERVAL":	Time between DNS propagation check in seconds (Default: 2)`)
		ew.writeln(`	- "ZILORE_PROPAGATION_TIMEOUT":	Maximum waiting time for DNS propagation in seconds (Default: 60)`)
		ew.writeln(`	- "ZILORE_TTL":	The TTL of the TXT record used for the DNS challenge in seconds (Default: 120)`)

		ew.writeln()
		ew.writeln(`More information: https://go-acme.github.io/lego/dns/zilore`)
